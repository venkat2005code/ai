...
const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
  ...
  return (
    <aside className={`w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 fixed inset-y-0 start-0 border-e border-slate-700/50 shadow-2xl z-50 transition-transform duration-300 flex flex-col lg:translate-x-0 ${
