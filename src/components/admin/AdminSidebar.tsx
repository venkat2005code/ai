...
const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
  ...
  return (
    <aside className={`w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 fixed inset-y-0 left-0 border-r border-slate-700/50 shadow-2xl z-50 transition-transform duration-300 flex flex-col lg:translate-x-0 ${isOpen ? 'translate-x-0' : 'max-lg:-translate-x-full'
      }`}>
      {/* Logo Section */}
