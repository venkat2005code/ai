...
const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
  ...
  return (
    <aside className={`w-64 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white flex flex-col fixed inset-y-0 start-0 z-50 transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : 'max-lg:ltr:-translate-x-full max-lg:rtl:translate-x-full'
      }`}>
      {/* Logo Section */}
